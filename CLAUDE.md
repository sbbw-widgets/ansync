...
- **Próximo (7d)** — Companion: MediaProjection capture → MediaCodec H.264 → QUIC client al daemon (vía MozillaSecurity/quinn-binding o JNI a quinn nativo? — decidir en 7d).
